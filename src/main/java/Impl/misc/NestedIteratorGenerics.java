...
// NestedInteger: 1
// NestedInteger: [1, 2]
// NestedInteger: [1, [7, 8, [2,5]]]
public class NestedIteratorGenerics <K> {

    private class NestedInteger<T> {

//        boolean isNumber;
//        T intVal;
//        List<T> list;
//
//        NestedInteger(boolean isNumber, T intVal, List<T> list){
...
//    public NestedIteratorGenerics(){
//        curr = new ArrayList<K>();
//    }
//
//    // Constructor initializes a single integer.
//    public NestedIteratorUber(K value) {
