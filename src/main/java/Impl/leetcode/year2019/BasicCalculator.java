...
public class BasicCalculator {
    ...
    Steps:
        Initialize Sign with +
        If ( encounters - calculate it recursively
        once reached to ) return whatever calculated, since this is end of braces.
        For any other character, evalute using normal approach maintaining local Stack
        Time : O(LengthOfString)
     */
    int index = 0;
